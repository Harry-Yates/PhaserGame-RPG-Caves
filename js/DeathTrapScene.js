...
export default class DeathTrapScene extends Phaser.Scene {
  constructor() {
    super("DeathTrapScene");
    this.enemies = [];
  }
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON("map", "./assets/images/DeathTrapScene/opening-scene-map.json");
  }
  ...
  create() {
    ...
    this.player = new Player({ scene: this, x: 180, y: 310, texture: "main_character", frame: "u1" });
